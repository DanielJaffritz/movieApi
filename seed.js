...
const userId = "99d05b39-95ba-41bf-8236-13384c05ad5b";
...
const main = async () => {
  ...
  try {
    for (const movie of movies) {
      await client.query(
        'INSERT INTO movies (title, overview, release_year, genres, runtime, posterUrl, createdBy) VALUES ($1, $2, $3, $4, $5, $6, $7);',
        [movie.title, movie.overview, movie.releaseYear, movie.genres, movie.runtime, movie.posterUrl, movie.createdBy])
    }
  } catch (error) {
    console.error("sda", error.stack)
  } finally {
    client.release();
    pool.end();
  }
